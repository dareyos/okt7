...
abstract class $PostsCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> tags, int id});
}
...
class _$PostsImpl implements _Posts {
  _$PostsImpl({required final List<String> tags, required this.id})
      : _tags = tags;
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_tags), id);
...
abstract class _Posts implements Posts {
  factory _Posts({required final List<String> tags, required final int id}) =
      _$PostsImpl;
